  ...
  return (
    <div style={{ padding: '32px 20px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #11120', padding: '32px 24px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        <h1 style={{ color: '#111', fontSize: '32px', fontWeight: 700, marginBottom: '16px' }}>About Minimalism</h1>
        <p style={{ color: '#11188', fontSize: '15px', lineHeight: 1.8, marginBottom: '16px' }}>We specialize in minimalism design — creating interfaces that are both beautiful and functional.</p>
