    ...
    <div style={{ padding: '32px 20px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #11120', padding: '32px 24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <p style={{ color: '#111', fontSize: '12px', fontWeight: 600, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '12px' }}>MINIMALISM DESIGN</p>
          <h1 style={{ color: '#111', fontSize: '40px', fontWeight: 700, marginBottom: '16px', lineHeight: 1.1 }}>Minimalism</h1>
          <p style={{ color: '#11188', fontSize: '15px', maxWidth: '480px', margin: '0 auto', lineHeight: 1.7 }}>A complete minimalism design showcase with interactive elements and professional aesthetics.</p>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
        <Link href="/minimalism/gallery" style={{ padding: '12px 28px', background: '#111', color: '#fff', borderRadius: '10px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>View Gallery</Link>
        <Link href="/minimalism/about" style={{ padding: '12px 28px', background: '#11115', color: '#111', borderRadius: '10px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>Learn More</Link>
      </div>
    </div>
  )
}
