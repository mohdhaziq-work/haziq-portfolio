...
export default function About() {
  return (
    <div style={{ padding: '32px 20px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #ff634820', padding: '32px 24px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        <h1 style={{ color: '#2d3436', fontSize: '32px', fontWeight: 700, marginBottom: '16px' }}>About Geometric</h1>
        <p style={{ color: '#2d343688', fontSize: '15px', lineHeight: 1.8, marginBottom: '16px' }}>We specialize in geometric design — creating interfaces that are both beautiful and functional.</p>
