...
export default function About() {
  return (
    <div style={{ padding: '32px 20px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ background: 'rgba(5,5,16,0.9)', borderRadius: '16px', border: '1px solid #00d4ff20', padding: '32px 24px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        <h1 style={{ color: '#eee', fontSize: '32px', fontWeight: 700, marginBottom: '16px' }}>About Futuristic</h1>
        <p style={{ color: '#eee88', fontSize: '15px', lineHeight: 1.8, marginBottom: '16px' }}>We specialize in futuristic design — creating interfaces that are both beautiful and functional.</p>
