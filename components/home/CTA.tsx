  ...
  return (
    <Section background="surface" padding="large">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <AnimatedText as="p" delay={400} className="mt-8 text-caption text-text-tertiary flex items-center justify-center gap-1.5">
          <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" className="text-success"><path d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z"/></svg>
          No commitment required &bull; Response within 2 hours
        </AnimatedText>
      </div>
    </Section>
  )
