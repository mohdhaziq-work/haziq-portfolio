          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="w-10 h-10 rounded-lg bg-background border border-border flex items-center justify-center text-text-tertiary hover:text-accent hover:border-accent/30 transition-all"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button
                  onClick={() => openInstagramDM()}
                  className="text-text-secondary text-body-sm hover:text-accent transition-colors flex items-center gap-2"
                >
            ...
            {/* Legal Links */}
            <h4 className="font-semibold text-text-primary mb-4 mt-6 text-body-sm">Legal</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/privacy-policy" className="text-text-secondary text-body-sm hover:text-accent transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms-of-service" className="text-text-secondary text-body-sm hover:text-accent transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
